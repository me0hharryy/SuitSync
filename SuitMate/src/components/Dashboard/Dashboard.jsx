      ...
      >
        <Grid container spacing={3} mb={3}>
          <Grid item xs={12} md={3}>
            <Card sx={{
              background: 'linear-gradient(135deg, #2a3460ff 0%, #442166ff 100%)',
              color: 'white',
              borderRadius: 2,
              boxShadow: 2
            }}>
          ...
          <Grid item xs={12} md={3}>
            <Card sx={{
              background: 'linear-gradient(135deg, #552a5bff 0%, #72202bff 100%)',
              color: 'white',
              borderRadius: 2,
              boxShadow: 2
            }}>
          ...
          <Grid item xs={12} md={3}>
            <Card sx={{
              background: 'linear-gradient(135deg, #1f507bff 0%, #0b848aff 100%)',
              color: 'white',
              borderRadius: 2,
              boxShadow: 2
            }}>
          ...
          <Grid item xs={12} md={3}>
            <Card sx={{
              background: 'linear-gradient(135deg, #295236ff 0%, #0d947bff 100%)',
              color: 'white',
              borderRadius: 2,
              boxShadow: 2
            }}>
